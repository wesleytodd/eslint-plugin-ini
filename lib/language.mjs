...
export default class INIParser {
  ...
  validateLanguageOptions (languageOptions) {
    if (
      typeof languageOptions?.compositeKeys !== 'boolean' &&
      typeof languageOptions?.compositeKeys !== 'undefined'
    ) {
      throw new TypeError('languageOptions.compositeKeys must be a boolean');
    }
  }
  ...
  parse (file, { languageOptions }) {
    try {
      const doc = parse(file.body, languageOptions);
